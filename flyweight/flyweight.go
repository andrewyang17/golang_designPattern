...
// storing externally the data associated with similar objects (avoid redundancy when storing data).
// Take all data that can repeat (common data) and store it externally.
